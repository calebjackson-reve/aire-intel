...
// ─────────────────────────────────────────────────────────────────────────────
// Cockpit — the previous "/" dashboard (CommandCenter + KPIs + market + queue).
// Preserved VERBATIM for instant rollback when Mission Control became Home
// (Caleb OS Sprint 1, 2026-06-29). To roll back: point src/app/page.tsx at
// <Cockpit/> instead of <MissionControl/>. Do not delete.
// ─────────────────────────────────────────────────────────────────────────────
